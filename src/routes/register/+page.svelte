...
<div class="flex min-h-screen flex-col bg-surface-50 px-6 py-12">
  ...
  <!-- Header -->
  <h1 class="mb-2 text-3xl font-bold text-surface-900">Criar conta</h1>
  <p class="mb-8 text-surface-700">Preencha os dados para criar sua conta</p>
    ...
    <label class="flex items-start gap-2 text-sm">
      ...
      <span class="text-surface-700">
        Eu li e concordo com os <a
          href="/termos"
          class="text-primary-500 hover:underline">Termos e Condições</a
        >
      </span>
    </label>
  ...
  >
    ...
    <span class="font-medium">Cadastrar com Google</span>
  </button>
  ...
  <p class="mt-6 text-center text-sm text-surface-700">
    Já possui uma conta? <a
      href="/login"
      class="font-medium text-primary-500 hover:underline">Realize login</a
    >
  </p>
</div>
